...
percent='90'
#ResultMeanStd(170,170,path,UNames,percent,Hemo_Dict,Non_hemo_Dict)#90_1mer
#ResultMeanStd(170,5,path,UNames,percent,Hemo_Dict,Non_hemo_Dict)#70_1mer
#ResultMeanStd(170,10,path,UNames,percent,Hemo_Dict,Non_hemo_Dict)#90ELMO
#ResultMeanStd(170,1,path,UNames,percent,Hemo_Dict,Non_hemo_Dict)#70ELMO
ResultMeanStd(170,170,path,UNames,percent,Hemo_Dict,Non_hemo_Dict)#902mer
1/0
#################90 new %
##path='D:/Downloads/'
