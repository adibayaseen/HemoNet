...
runs=10
print("5-fold")
Featurename='ELMO_AAC2_Smile'
Classifier=SVC
print(Classifier)
ResultMeanStd_SVM_5fold(runs,Classifier,Features,Label,'rbf',1,512,Featurename,Hemo_Dict,Non_hemo_Dict)#1mer_Smile based XGboost
...
percent='90'
print(Classifier,"\n",percent)
ResultMeanStd_SVM_NR_fold(percent,UNames,runs,Classifier,Features,Label,'rbf',100,1e-05  ,Featurename,Hemo_Dict,Non_hemo_Dict)
percent='70'
print(Classifier,"\n",percent)
ResultMeanStd_SVM_NR_fold(percent,UNames,runs,Classifier,Features,Label,'linear',16,0.01 ,Featurename,Hemo_Dict,Non_hemo_Dict)
#Classifier=SVC
#ResultMeanStd_SVM_5fold(runs,Classifier,Features,Label,'rbf',256,0.001,Featurename,Hemo_Dict,Non_hemo_Dict)#1mer_Smile based XGboost
#print("Total feature dimension",len(Features[0]),Featurename)
1/0
Classifier=XGBClassifier#RandomForestClassifier#XGBClassifier#
#
##145,10
#XGB
ResultMeanStd_5fold(runs,Classifier,Features,Label,90,140,Featurename,Hemo_Dict,Non_hemo_Dict)#ELMO_Smile based XGboost
1/0
percent='90'
UNames=new_RemoveDuplicates(path,'new_HemoltkAndDBAASP_all_seq.fasta.clstr.sorted')
print(Classifier,"\n",percent)
###XGB parameters
ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,200,10,Featurename,Hemo_Dict,Non_hemo_Dict)
print("Total feature dimension",len(Features[0]),Featurename)
percent='70'
ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,160,25,Featurename,Hemo_Dict,Non_hemo_Dict)
print("Total feature dimension",len(Features[0]),Featurename)
1/0
#Classifier=RandomForestClassifier#XGBClassifier#
#ResultMeanStd_5fold(runs,Classifier,Features,Label,200,200,Featurename,Hemo_Dict,Non_hemo_Dict)#ELMO_Smile based XGboost
#percent='90'
#UNames=new_RemoveDuplicates(path,'new_HemoltkAndDBAASP_all_seq.fasta.clstr.sorted')
#print(Classifier,"\n",percent)
####XGB parameters
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,200,90,Featurename,Hemo_Dict,Non_hemo_Dict)
#percent='70'
#print(Classifier,"\n",percent)
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,100,55,Featurename,Hemo_Dict,Non_hemo_Dict)
#print("Total feature dimension",len(Features[0]),Featurename)
Featurename='ELMO_AAC2_Smile'
#Classifier=RandomForestClassifier#2mer
#ResultMeanStd_5fold(runs,Classifier,Features,Label,200,200,Featurename,Hemo_Dict,Non_hemo_Dict)#ELMO_Smile based XGboost
#percent='90'
#UNames=new_RemoveDuplicates(path,'new_HemoltkAndDBAASP_all_seq.fasta.clstr.sorted')
#print(Classifier,"\n",percent)
...
#print("Total feature dimension",len(Features[0]),Featurename)
#1/0
#Classifier=XGBClassifier#2mer
#ResultMeanStd_5fold(runs,Classifier,Features,Label,200,200,Featurename,Hemo_Dict,Non_hemo_Dict)#ELMO_Smile based XGboost
#percent='90'
#UNames=new_RemoveDuplicates(path,'new_HemoltkAndDBAASP_all_seq.fasta.clstr.sorted')
#print(Classifier,"\n",percent)
####XGB parameters
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,145,140,Featurename,Hemo_Dict,Non_hemo_Dict)
#percent='70'
#print(Classifier,"\n",percent)
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,100,55,Featurename,Hemo_Dict,Non_hemo_Dict)
#print("Total feature dimension",len(Features[0]),Featurename)
