...
####
N_terminous_Smiles_features=pickle.load(open(path+'Nmod_Dict_FCFP2'+str(dimension)+'.npy', "rb"))
C_terminous_Smiles_features=pickle.load(open(path+'Cmod_Dict_FCFP2'+str(dimension)+'.npy', "rb"))
###
