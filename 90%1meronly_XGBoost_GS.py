...
Features=AAC_Features#np.hstack((AAC_Features,oneHot_features))
...
percent='90'
#170,170 90 p external results are good 0.740.6503 ± 0.0 
# 0.6043 ± 0.0 
# 0.26 ± 0.0 
# 0.6731 ± 0.0 
# 0.5476 ± 0.0 
# 0.1909 ± 0.0 
# 0.7433 ± 0.0559 
ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,200,20,Featurename,Hemo_Dict,Non_hemo_Dict)
