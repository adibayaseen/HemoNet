...
Hemo_AAC=All_FeaturesWithoutNC(path,path+'hemo_All_seq.txt',mer)
Non_hemo_AAC=  All_FeaturesWithoutNC(path,path+'Nonhemo_All_seq.txt',mer)
...
Hemo_Dict=dict(zip(Names_hemo,np.hstack((list(Hemo_AAC.values()),list(NC_hemo_dict.values())))))
Non_hemo_Dict=dict(zip(Names_non_hemo,np.hstack((list(Non_hemo_AAC.values()),list(NC_non_hemo_dict.values())))))
...
print ("SVM With Normalization of features Execution Completed")
runs=10
...
percent='90'
#print(Classifier,"\n",percent)
ResultMeanStd_SVM_NR_fold(percent,UNames,runs,Classifier,Features,Label,'linear',64,0 ,Featurename,Hemo_Dict,Non_hemo_Dict)
percent='70'
print(Classifier,"\n",percent)
ResultMeanStd_SVM_NR_fold(percent,UNames,runs,Classifier,Features,Label,'rbf',256,0.001 ,Featurename,Hemo_Dict,Non_hemo_Dict)
1/0
#Classifier='NN'
#print("5-fold")
...
#print(Classifier,"\n",percent)
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,0,0,Featurename,Hemo_Dict,Non_hemo_Dict)
#Featurename='AAC2_Smile'
#Classifier=SVC
#print(Classifier)
#ResultMeanStd_SVM_5fold(runs,Classifier,Features,Label,'rbf',32,256,Featurename,Hemo_Dict,Non_hemo_Dict)#1mer_Smile based XGboost
#print("Total feature dimension",len(Features[0]),Featurename)
#percent='90'
#print(Classifier,"\n",percent)
#ResultMeanStd_SVM_NR_fold(percent,UNames,runs,Classifier,Features,Label,'linear',64,0 ,Featurename,Hemo_Dict,Non_hemo_Dict)
#percent='70'
#print(Classifier,"\n",percent)
#ResultMeanStd_SVM_NR_fold(percent,UNames,runs,Classifier,Features,Label,'linear',100,0 ,Featurename,Hemo_Dict,Non_hemo_Dict)
#1/0
...
#runs=10
#ResultMeanStd_5fold(runs,Classifier,Features,Label,140,50,Featurename,Hemo_Dict,Non_hemo_Dict)#1mer_Smile based XGboost
#print("Total feature dimension",len(Features[0]),Featurename)
#percent='90'
#UNames=new_RemoveDuplicates(path,'new_HemoltkAndDBAASP_all_seq.fasta.clstr.sorted')
#print(Classifier,"\n",percent)
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,185,10,Featurename,Hemo_Dict,Non_hemo_Dict)
#percent='70'
#print(Classifier,"\n",percent)
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,170,5,Featurename,Hemo_Dict,Non_hemo_Dict)
#print("Total feature dimension",len(Features[0]),Featurename)
...
Classifier=SVC
runs=10
ResultMeanStd_SVM_5fold(runs,Classifier,Features,Label,'rbf',128,128,Featurename,Hemo_Dict,Non_hemo_Dict)#1mer_Smile based XGboost
print("Total feature dimension",len(Features[0]),Featurename)
1/0
percent='90'
UNames=new_RemoveDuplicates(path,'new_HemoltkAndDBAASP_all_seq.fasta.clstr.sorted')
