...
class HemoNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(5120, 512)#1024)
...
####
N_terminous_Smiles_features=pickle.load(open(path+'Nmod_Dict.npy', "rb"))
N_terminous_Smiles_features['Free']=' ',np.zeros(2048)
C_terminous_Smiles_features=pickle.load(open(path+'Cmod_Dict.npy', "rb"))
C_terminous_Smiles_features['Free']=' ',np.zeros(2048)
