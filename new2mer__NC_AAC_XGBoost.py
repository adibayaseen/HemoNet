...
###2mer_RF
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,130,50,Featurename,Hemo_Dict,Non_hemo_Dict)#RF 78 percent
#percent='70'
#print(percent)
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,170,1,Featurename,Hemo_Dict,Non_hemo_Dict)
...
print(percent)
ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,170,1,Featurename,Hemo_Dict,Non_hemo_Dict)
ResultMeanStd_5fold(runs,Classifier,Features,Label,130,15,Featurename,Hemo_Dict,Non_hemo_Dict)#1mer_Smile based XGboost
print("Total feature dimension",len(Features[0]),Featurename)
1/0
