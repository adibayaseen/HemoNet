...
## Code Structure
[weights.hdf ](https://github.com/adibayaseen/HemoNet/blob/main/weights.hdf)<br/>  weights.hdf file have link of google drive in which neural network weights  of SeqVec features are stored
