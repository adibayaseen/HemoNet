...
runs=10
print("5-fold")
#ResultMeanStd_5fold(runs,Classifier,Features,Label,170,5,Featurename,Hemo_Dict,Non_hemo_Dict)#ELMO_Smile based XGboost
#1/0
percent='0'
##UNames=new_RemoveDuplicates(path,'new_HemoltkAndDBAASP_all_seq.fasta.clstr.sorted')
...
#Classifier=SVC
#print(Classifier)
#ResultMeanStd_SVM_5fold(runs,Classifier,Features,Label,'rbf',1,64,Featurename,Hemo_Dict,Non_hemo_Dict)#1mer_Smile based XGboost
#print("Total feature dimension",len(Features[0]),Featurename)
#percent='90'
#print(Classifier,"\n",percent)
#ResultMeanStd_SVM_NR_fold(percent,UNames,runs,Classifier,Features,Label,'linear',128,0 ,Featurename,Hemo_Dict,Non_hemo_Dict)
#percent='70'
#print(Classifier,"\n",percent)
...
print(Classifier,"\n",percent)
###XGB parameters
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,70,200,Featurename,Hemo_Dict,Non_hemo_Dict)#RF 78 percent
#percent='70'
#print(percent)
#ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,170,1,Featurename,Hemo_Dict,Non_hemo_Dict)
#ResultMeanStd_5fold(runs,Classifier,Features,Label,120,11,Featurename,Hemo_Dict,Non_hemo_Dict)#1mer_Smile based XGboost
#1/0
#RF parameters
ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,170,170,Featurename,Hemo_Dict,Non_hemo_Dict)#RF 78 percent
percent='70'
print(percent)
ResultMeanStd_NR_fold(percent,UNames,runs,Classifier,Features,Label,170,5,Featurename,Hemo_Dict,Non_hemo_Dict)
